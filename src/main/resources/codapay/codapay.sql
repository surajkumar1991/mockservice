...
INSERT INTO `` (`txn_type`,`api_key`,`json`) VALUES ('codapay_check_status','394b3f5c092d3c5bb1a5112928c7b997','{\"subscriptionResult\":{\"resultCode\":0,\"subscriptionInfo\":{\"subscriptionId\":501,\"subscriptionStatus\":\"Active\"}}}');
INSERT INTO `` (`txn_type`,`api_key`,`json`) VALUES ('codapay_init_txn','6f4f89e0b7fe3f607267478df27991d4','<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?>\n<initResult>\n    <resultCode>0</resultCode>\n    <txnId>5497300735439847964</txnId>\n</initResult>');
